...
class CenterlineDatasetSpherical(Dataset):
    def __init__(self, base_dir, transform=None):
        self.origin_2D = torch.load(os.path.join(base_dir, "origin_2D_interp.pt"))
        self.origin_3D = torch.load(os.path.join(base_dir, "origin_3D_interp.pt"))
        self.shape_2D = torch.load(os.path.join(base_dir, "shape_2D_interp.pt"))
        self.shape_3D = torch.load(os.path.join(base_dir, "shape_3D_interp.pt"))
